    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 px-4">
      <div className="max-w-md rounded-3xl bg-white p-8 shadow-xl">
        <div className="mb-6 text-center">
          ...
          <p className="mt-2 text-gray-600">متأسفانه خطایی در صفحه حساب کاربری رخ داده است.</p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <Link href="/" className="block">
            <button className="w-full rounded-lg border border-gray-200 px-6 py-3 font-medium text-gray-600 transition-colors hover:bg-gray-50 active:scale-95">
              بازگشت به خانه
            </button>
          </Link>
        </div>
