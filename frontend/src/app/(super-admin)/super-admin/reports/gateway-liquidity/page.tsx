            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-purple-600">
                        {totalLiquidity.toLocaleString()} تومان
                      </p>
                    </div>
                ...
                <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-6 border border-orange-100">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-lg font-medium text-neutral-700 mb-2">درگاه‌های فعال</h3>
              ...
              {/* Chart Section */}
              <div>
                <h3 className="text-lg font-medium text-neutral-700 mb-4">توزیع نقدینگی بین درگاه‌های پرداخت</h3>
...
function GatewayLiquidityChart({ rows }: { rows: Array<{ gatewayTitle: string; total: number }> }) {
  ...
  const chartData = rows.map((row, index) => ({
    ...
    percentage: ((Number(row.total) / rows.reduce((sum, r) => sum + Number(r.total), 0)) * 100).toFixed(1)
  }));
        ...
        <div className="bg-white p-4 border border-neutral-200 rounded-lg shadow-lg" dir="rtl">
          ...
          <div className="space-y-1 text-sm">
            <p className="text-purple-600">
              <span className="font-medium">مبلغ:</span> {data.value.toLocaleString()} تومان
            </p>
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-center lg:items-start">
        ...
        <div className="flex-1 min-w-0 w-full lg:w-auto">
          <div className="space-y-3">
            <h4 className="text-sm font-medium text-neutral-700 mb-4 text-right">درگاه‌های پرداخت</h4>
            {chartData.map((item, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg hover:bg-neutral-100 transition-colors" dir="rtl">
          ...
          <div className="mt-6 p-4 bg-gradient-to-r from-neutral-50 to-neutral-100 rounded-lg">
            <div className="flex items-center justify-between text-sm" dir="rtl">
              ...
              <span className="font-medium text-neutral-800">{rows.length} درگاه</span>
            </div>
          </div>
        </div>
      </div>
