  ...
  return (
    ...
    >
      ...
      <div className="flex max-h-[85vh] flex-col">
        {/* Header */}
        <div className="relative border-b border-black/5 px-6 py-4">
          <h3
          ...
          <button
            ...
            aria-label="بستن"
            className="absolute right-4 top-1/2 -translate-y-1/2 rounded-xl p-2 text-gray-600 transition hover:bg-black/5 hover:text-gray-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-pink-500"
          >
