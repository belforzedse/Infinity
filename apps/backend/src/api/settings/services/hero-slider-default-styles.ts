import type { HeroTextStyle } from "./hero-slider-types";

export const DEFAULT_TOP_HEADLINE_TITLE_STYLE: HeroTextStyle = {
  color: "#94B5D2",
...
export const DEFAULT_TOP_HEADLINE_SUBTITLE_STYLE: HeroTextStyle = {
  color: "text-gray-600",
  fontFamily: "font-kaghaz",
...
export const DEFAULT_PRIMARY_TITLE_STYLE: HeroTextStyle = {
  color: "text-gray-900",
  fontFamily: "font-kaghaz",
...
export const DEFAULT_PRIMARY_SUBTITLE_STYLE: HeroTextStyle = {
  color: "text-gray-600",
  fontFamily: "font-kaghaz",
...
export const DEFAULT_DESKTOP_HEADLINE_CLASSNAME =
...
export const DEFAULT_DESKTOP_CARD_LEFT_IMAGE_CLASSNAME =
  "h-full w-full rounded-lg mb-2 -translate-y-4 object-contain";
export const DEFAULT_DESKTOP_CARD_RIGHT_IMAGE_CLASSNAME =
  "h-full w-full rounded-lg pl-2 object-contain";
export const DEFAULT_CARD_BACKGROUND_CLASSNAME = "rounded-3xl";
export const DEFAULT_CARD_BUTTON_CLASSNAME = "text-white text-[20px] font-normal rounded-lg";
export const DEFAULT_CARD_PADDING_CLASSNAME = "px-4 py-4 pr-8";

export const DEFAULT_DESKTOP_MAIN_VISUAL_BACKGROUND_WIDTH = "520px";
export const DEFAULT_DESKTOP_MAIN_VISUAL_BACKGROUND_HEIGHT = "427px";
export const DEFAULT_DESKTOP_MAIN_VISUAL_BACKGROUND_POSITION = "bottom center";
export const DEFAULT_DESKTOP_MAIN_VISUAL_BACKGROUND_SIZE = "cover";
export const DEFAULT_DESKTOP_MAIN_VISUAL_BACKGROUND_CLASSNAME = "rounded-3xl";

export const DEFAULT_TABLET_MAIN_VISUAL_BACKGROUND_WIDTH = "100%";
