...
import { extractErrorStatus } from "@/utils/extractErrorStatus";
  ...
  useEffect(() => {
    ...
    const sendInitialOTP = async () => {
      try {
        ...
        toast.error(getUserFacingErrorMessage(error, "کد تایید ارسال نشده است"));
      }
    };
      ...
      <VerifyForgotPasswordForm
        resendCode={async () => {
          try {
            ...
            toast.error(getUserFacingErrorMessage(error, "خطا در ارسال کد تایید"));
          }
        }}
    ...
    <Suspense
      fallback={
        <div className="mx-auto w-full p-8">
          <SuspenseLoader fullscreen={false} message="در حال بارگذاری..." />
        </div>
      }
    >
      <VerifyContent />
