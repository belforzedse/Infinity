    ...
    <div className="flex w-full gap-3">
      {code.map((digit, index) => (
        <input
          ...
          className="text-2xl aspect-square w-[18%] rounded-[10px] bg-slate-200 text-center transition-all hover:bg-slate-100 focus:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-infinity-primary"
          style={{
