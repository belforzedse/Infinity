    ...
    <>
      ...
      <div className="mt-5 flex flex-col-reverse gap-5 md:flex-row-reverse">
        <AuthButton
          ...
          className="border border-infinity-primary !bg-transparent !text-infinity-primary hover:!bg-slate-100"
          icon={<CodeIcon className="h-5 w-5 text-infinity-primary md:h-6 md:w-6" />}
        >
          فراموشی رمز عبور
        </AuthButton>
        ...
        <AuthButton
          ...
          onClick={onOtpLogin}
          className="border border-infinity-primary !bg-transparent !text-infinity-primary hover:!bg-slate-100"
          icon={<OtpIcon className="h-5 w-5 text-infinity-primary md:h-6 md:w-6" />}
        >
