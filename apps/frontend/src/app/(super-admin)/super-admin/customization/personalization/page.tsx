        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-600">
              تنظیمات ظاهری و تجربه کاربری را از اینجا مدیریت کنید.
            </p>
          </div>
          <div className="hidden h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-[#D6EAEB] to-amber-50 text-[#4F8E92] md:flex">
        ...
        {tiles.map((tile) => (
          ...
          >
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#E8F3F4] text-[#4F8E92]">
                {tile.icon}
              </div>
              <div>
