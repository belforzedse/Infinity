...
function PromoSlot({ slot }: { slot: HomeGifPromoSlot }) {
  ...
  return (
    <div className="grid min-w-0 grid-cols-1 gap-3 sm:grid-cols-[minmax(0,1fr)_minmax(190px,42vw)] lg:grid-cols-[minmax(0,240px)_329.5px]">
      <div className="grid min-w-0 grid-cols-1 gap-2 xs:grid-cols-2 sm:grid-cols-1">
